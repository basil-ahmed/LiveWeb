...
app.use('/chatApp', express.static('public'));
...
var options = {
  key: fs.readFileSync('/etc/letsencrypt/live/bq2024.imany.io/privkey.pem'),
  cert: fs.readFileSync('/etc/letsencrypt/live/bq2024.imany.io/fullchain.pem')
};
